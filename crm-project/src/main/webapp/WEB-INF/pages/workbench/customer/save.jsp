		...
		<script type="text/javascript">
			$(function(){
				...
				$("#create-transactionStage").change(function(){
					...
					//发送请求
					$.ajax({
						url:"workbench/customer/getPossibilityByStageValue.do",
						type:"post",
						dataType:"json",
						data:{
				...
				$("#queryActivityByName").keyup(function(){
					...
					//发送请求
					$.ajax({
						url:"workbench/customer/queryActivityForDetailByName.do",
						type:"post",
						dataType: "json",
						data:{
							name:name
				...
				$("#queryContactsByName").keyup(function(){
					...
					//发送请求
					$.ajax({
						url:"workbench/customer/queryContactsForDetailByName.do",
						type:"post",
						dataType:"json",
						data:{
							name:name
						...
						success:function(data){
							...
							$.each(data,function(){
								htmlStr+="<tr>";
								htmlStr+="<td><input contactsId=\""+this.id+"\" type=\"radio\" name=\""+this.fullName+"\"/></td>";
				...
				$("#saveCreateTranBtn").click(function(){
					...
					//发送请求
					$.ajax({
						url:"workbench/customer/saveCreateTran.do",
						dataType:"json",
						type:"post",
						data:{
							owner:owner,
						...
						success:function(data){
							if(data.code=="0"){
								...
								//返回客户明细页面
								window.location.href="workbench/customer/queryCustomerForDetailById.do?id="+customerId;
							}
						}
					})
				});
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="text" class="form-control" id="create-accountName" placeholder="支持自动补全，输入客户不存在则新建" value="${name}" readonly>
			</div>
